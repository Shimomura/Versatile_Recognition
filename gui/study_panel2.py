...
class StudyPanel(base.ContentsPanelBase):
    ...
    def start_study(self, evt): #change
        ...
        name_label = wx.StaticText(self, wx.ID_ANY, u"学習結果", pos=(10,170), size=(400,50))
        name_label.SetFont(font)

        name_text = wx.StaticText(self, wx.ID_ANY, stdout_data, pos=(10,195), size=(450,30))
        name_text.SetFont(font)
